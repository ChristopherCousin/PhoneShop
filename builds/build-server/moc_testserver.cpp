...
QT_MOC_LITERAL(6, 62, 18) // "socketDisconnected"
    ...
    "TestServer\0closed\0\0onNewConnection\0"
...
void TestServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        TestServer *_t = static_cast<TestServer *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (TestServer::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TestServer::closed)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject TestServer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TestServer.data,
      qt_meta_data_TestServer,  qt_static_metacall, nullptr, nullptr}
};
